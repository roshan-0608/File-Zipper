...
void huffman::createMinHeap() {
    ...
    cout << "Min heap created with size: " << minHeap.size() << endl;
}
...
// All your compress(), decompress(), etc. functions

#include "huffman.hpp"


// Add main() here instead of a separate main.cpp
int main(int argc, char* argv[]) {
    if (argc != 4) {
        cout << "Usage:\n";
        cout << "To compress:   ./huffman encode input.txt output.huf\n";
        cout << "To decompress: ./huffman decode input.huf output.txt\n";
        return 1;
    }
    ...
    if (mode == "encode") {
        ...
        cout << "Invalid mode. Use 'encode' or 'decode'.\n";
    }
